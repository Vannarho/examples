...
# Resolve conventions.xml relative to this script directory to avoid CWD issues
_here = os.path.abspath(os.path.dirname(__file__))
_repo = os.path.abspath(os.path.join(_here, os.pardir, os.pardir))
convFile = os.path.join(_repo, "Input", "conventions.xml")
if not os.path.exists(convFile):
    # Fallbacks for alternate layout
    alt = [
        os.path.join(_repo, "..", "Input", "conventions.xml"),
    ...
    for a in alt:
        if os.path.exists(a):
            convFile = a
            break
print("Loading conventions from:", os.path.relpath(convFile, _repo))
