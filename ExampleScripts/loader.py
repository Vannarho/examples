...
# Delta: robust file paths relative to this script
_here = os.path.abspath(os.path.dirname(__file__))
_repo = os.path.abspath(os.path.join(_here, os.pardir, os.pardir))
csv_loader = CSVLoader(os.path.join(_repo, "Input", "market_20160205.txt"),
                       os.path.join(_repo, "Input", "fixings_20160205.txt"), True)
