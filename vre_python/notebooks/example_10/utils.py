...
def describe_master_portfolio(master_xml_path, quiet: bool = False):
    ...
    try:
        ...
        if setup_ip:
            # Typical masters sit under .../examples/<family>/input, with inputPath like "Input/SA-CCR"
            # Prefer parent-of-input joined to inputPath, then fallback to sibling under current parent.
            parent_of_input = mpath.parent.parent  # e.g., examples/regulatory/pillar_1/credit/ccr
