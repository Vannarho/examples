...
def run_pca():
        ...
        data = pd.read_csv(output_root + '/scenariodump.csv')
        ...
        # output results
        with open(output_root + '/eigenvalues.csv', 'w', newline='') as file1:
        ...
        with open(output_root + '/eigenvectors.csv', 'w', newline='') as file2:
